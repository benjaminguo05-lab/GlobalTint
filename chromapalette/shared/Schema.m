    ...
    dispatch_once(&once, ^{
        groups = @[
            ...
            G(@"toolbar", @"工具栏", @"适用于使用系统工具栏的界面。", NO, @[
                ...
                R(@"background", @"背景", @"#ECF8F2", @"#162C23", NO)]),
            G(@"accent", @"通用蓝色强调色", @"一个开关统一替换应用中的系统蓝色按钮、链接、图标和加载进度。原生颜色选择器支持浅色、深色及透明度。更改后请重开应用，以更新它缓存的图像和颜色。", NO, @[
                R(@"color", @"统一强调色", @"#168A60", @"#5CDBAA", YES)]),
            G(@"switch", @"切换开关", @"修改开启、关闭轨道，也适用于 iOS全局改色 设置页的开关；滑钮保持原样。", NO, @[
